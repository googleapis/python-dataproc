...
class ClusterOperationStatus(proto.Message):
    ...
    state_start_time = proto.Field(proto.MESSAGE, number=4,
...
class ClusterOperationMetadata(proto.Message):
    ...
    Attributes:
        ...
        status (google.cloud.dataproc_v1beta2.types.ClusterOperationStatus):
            Output only. Current operation status.
        status_history (Sequence[google.cloud.dataproc_v1beta2.types.ClusterOperationStatus]):
            Output only. The previous operation status.
        operation_type (str):
            Output only. The operation type.
        description (str):
            Output only. Short description of operation.
        labels (Sequence[google.cloud.dataproc_v1beta2.types.ClusterOperationMetadata.LabelsEntry]):
    ...
    status = proto.Field(proto.MESSAGE, number=9,
        message='ClusterOperationStatus',
    )

    status_history = proto.RepeatedField(proto.MESSAGE, number=10,
        message='ClusterOperationStatus',
    )
