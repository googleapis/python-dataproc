...
class LoggingConfig(proto.Message):
    ...
    Attributes:
        driver_log_levels (Sequence[google.cloud.dataproc_v1beta2.types.LoggingConfig.DriverLogLevelsEntry]):
...
class PySparkJob(proto.Message):
    ...
    Attributes:
        ...
        archive_uris (Sequence[str]):
            ...
            executor. Supported file types: .jar, .tar,
            .tar.gz, .tgz, and .zip.
        properties (Sequence[google.cloud.dataproc_v1beta2.types.PySparkJob.PropertiesEntry]):
            Optional. A mapping of property names to
...
class QueryList(proto.Message):
    ...
    Attributes:
        queries (Sequence[str]):
            ...
            terminate a query with a semicolon. Multiple queries can be
            specified in one string by separating each with a semicolon.
            Here is an example of an Cloud Dataproc API snippet that
...
class HiveJob(proto.Message):
    ...
    Attributes:
        ...
        script_variables (Sequence[google.cloud.dataproc_v1beta2.types.HiveJob.ScriptVariablesEntry]):
            Optional. Mapping of query variable names to values
            (equivalent to the Hive command: ``SET name="value";``).
        properties (Sequence[google.cloud.dataproc_v1beta2.types.HiveJob.PropertiesEntry]):
...
class SparkSqlJob(proto.Message):
    ...
    Attributes:
        ...
        query_list (google.cloud.dataproc_v1beta2.types.QueryList):
            A list of queries.
        script_variables (Sequence[google.cloud.dataproc_v1beta2.types.SparkSqlJob.ScriptVariablesEntry]):
            Optional. Mapping of query variable names to values
            (equivalent to the Spark SQL command: SET
            ``name="value";``).
        properties (Sequence[google.cloud.dataproc_v1beta2.types.SparkSqlJob.PropertiesEntry]):
            Optional. A mapping of property names to
...
class JobStatus(proto.Message):
    ...
    Attributes:
        state (google.cloud.dataproc_v1beta2.types.JobStatus.State):
            Output only. A state message specifying the
            overall job state.
        details (str):
            Output only. Optional Job state details, such
            as an error description if the state is
            <code>ERROR</code>.
        state_start_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The time when this state was
            entered.
        substate (google.cloud.dataproc_v1beta2.types.JobStatus.Substate):
...
class JobReference(proto.Message):
    ...
    Attributes:
        ...
        job_id (str):
            ...
            numbers (0-9), underscores (_), or hyphens (-). The maximum
...
class YarnApplication(proto.Message):
    ...
    **Beta Feature**: This report is available for testing purposes
    ...
    Attributes:
        ...
        state (google.cloud.dataproc_v1beta2.types.YarnApplication.State):
            Output only. The application state.
        progress (float):
            Output only. The numerical progress of the
            application, from 1 to 100.
        tracking_url (str):
            Output only. The HTTP URL of the
...
class JobScheduling(proto.Message):
    ...
    Attributes:
        max_failures_per_hour (int):
            ...
            terminating with non-zero code before job is
            reported failed.
...
class SubmitJobRequest(proto.Message):
    ...
    Attributes:
        ...
        request_id (str):
            ...
            server receives two
            [SubmitJobRequest][google.cloud.dataproc.v1beta2.SubmitJobRequest]
            requests with the same id, then the second request will be
            ignored and the first
            [Job][google.cloud.dataproc.v1beta2.Job] created and stored
...
class ListJobsRequest(proto.Message):
    ...
    Attributes:
        ...
        cluster_name (str):
            ...
            named cluster.
        job_state_matcher (google.cloud.dataproc_v1beta2.types.ListJobsRequest.JobStateMatcher):
...
class ListJobsResponse(proto.Message):
    ...
    Attributes:
        jobs (Sequence[google.cloud.dataproc_v1beta2.types.Job]):
