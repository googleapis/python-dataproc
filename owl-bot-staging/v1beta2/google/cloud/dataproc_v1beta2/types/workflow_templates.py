...
class WorkflowTemplate(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            updated.
        labels (Sequence[google.cloud.dataproc_v1beta2.types.WorkflowTemplate.LabelsEntry]):
        ...
        placement (google.cloud.dataproc_v1beta2.types.WorkflowTemplatePlacement):
            Required. WorkflowTemplate scheduling
            information.
        jobs (Sequence[google.cloud.dataproc_v1beta2.types.OrderedJob]):
            Required. The Directed Acyclic Graph of Jobs
            to submit.
        parameters (Sequence[google.cloud.dataproc_v1beta2.types.TemplateParameter]):
    ...
    placement = proto.Field(proto.MESSAGE, number=7,
        message='WorkflowTemplatePlacement',
    )

    jobs = proto.RepeatedField(proto.MESSAGE, number=8,
        message='OrderedJob',
    )

    parameters = proto.RepeatedField(proto.MESSAGE, number=9,
        message='TemplateParameter',
    )

    dag_timeout = proto.Field(proto.MESSAGE, number=10,
...
class WorkflowTemplatePlacement(proto.Message):
    ...
    Attributes:
        managed_cluster (google.cloud.dataproc_v1beta2.types.ManagedCluster):
            Optional. A cluster that is managed by the
            workflow.
        cluster_selector (google.cloud.dataproc_v1beta2.types.ClusterSelector):
    ...
    managed_cluster = proto.Field(proto.MESSAGE, number=1, oneof='placement',
        message='ManagedCluster',
    )

    cluster_selector = proto.Field(proto.MESSAGE, number=2, oneof='placement',
...
class ClusterSelector(proto.Message):
    ...
    Attributes:
        ...
        cluster_labels (Sequence[google.cloud.dataproc_v1beta2.types.ClusterSelector.ClusterLabelsEntry]):
...
class OrderedJob(proto.Message):
    ...
    hadoop_job = proto.Field(proto.MESSAGE, number=2, oneof='job_type',
        message=gcd_jobs.HadoopJob,
    )

    spark_job = proto.Field(proto.MESSAGE, number=3, oneof='job_type',
        message=gcd_jobs.SparkJob,
    )

    pyspark_job = proto.Field(proto.MESSAGE, number=4, oneof='job_type',
        message=gcd_jobs.PySparkJob,
    )

    hive_job = proto.Field(proto.MESSAGE, number=5, oneof='job_type',
        message=gcd_jobs.HiveJob,
    )

    pig_job = proto.Field(proto.MESSAGE, number=6, oneof='job_type',
        message=gcd_jobs.PigJob,
    )

    spark_r_job = proto.Field(proto.MESSAGE, number=11, oneof='job_type',
        message=gcd_jobs.SparkRJob,
    )

    spark_sql_job = proto.Field(proto.MESSAGE, number=7, oneof='job_type',
        message=gcd_jobs.SparkSqlJob,
    )

    presto_job = proto.Field(proto.MESSAGE, number=12, oneof='job_type',
        message=gcd_jobs.PrestoJob,
    )

    labels = proto.MapField(proto.STRING, proto.STRING, number=8)

    scheduling = proto.Field(proto.MESSAGE, number=9,
...
class TemplateParameter(proto.Message):
    ...
    Attributes:
        ...
        validation (google.cloud.dataproc_v1beta2.types.ParameterValidation):
    ...
    validation = proto.Field(proto.MESSAGE, number=4,
...
class ParameterValidation(proto.Message):
    ...
    Attributes:
        ...
        values (google.cloud.dataproc_v1beta2.types.ValueValidation):
            Validation based on a list of allowed values.
    """

    regex = proto.Field(proto.MESSAGE, number=1, oneof='validation_type',
        message='RegexValidation',
    )

    values = proto.Field(proto.MESSAGE, number=2, oneof='validation_type',
...
class WorkflowMetadata(proto.Message):
    ...
    Attributes:
        ...
        create_cluster (google.cloud.dataproc_v1beta2.types.ClusterOperation):
            Output only. The create cluster operation
            metadata.
        graph (google.cloud.dataproc_v1beta2.types.WorkflowGraph):
            Output only. The workflow graph.
        delete_cluster (google.cloud.dataproc_v1beta2.types.ClusterOperation):
            Output only. The delete cluster operation
            metadata.
        state (google.cloud.dataproc_v1beta2.types.WorkflowMetadata.State):
            Output only. The workflow state.
        cluster_name (str):
            Output only. The name of the target cluster.
        parameters (Sequence[google.cloud.dataproc_v1beta2.types.WorkflowMetadata.ParametersEntry]):
    ...
    create_cluster = proto.Field(proto.MESSAGE, number=3,
        message='ClusterOperation',
    )

    graph = proto.Field(proto.MESSAGE, number=4,
        message='WorkflowGraph',
    )

    delete_cluster = proto.Field(proto.MESSAGE, number=5,
        message='ClusterOperation',
    )
    ...
    start_time = proto.Field(proto.MESSAGE, number=9,
        message=timestamp.Timestamp,
    )
    ...
    dag_timeout = proto.Field(proto.MESSAGE, number=12,
        message=duration.Duration,
    )

    dag_start_time = proto.Field(proto.MESSAGE, number=13,
        message=timestamp.Timestamp,
    )

    dag_end_time = proto.Field(proto.MESSAGE, number=14,
        message=timestamp.Timestamp,
    )
...
class WorkflowGraph(proto.Message):
    ...
    Attributes:
        nodes (Sequence[google.cloud.dataproc_v1beta2.types.WorkflowNode]):
...
class WorkflowNode(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.dataproc_v1beta2.types.WorkflowNode.NodeState):
...
class CreateWorkflowTemplateRequest(proto.Message):
    ...
    template = proto.Field(proto.MESSAGE, number=2,
...
class InstantiateWorkflowTemplateRequest(proto.Message):
    ...
    instance_id = proto.Field(proto.STRING, number=3)

    request_id = proto.Field(proto.STRING, number=5)

    parameters = proto.MapField(proto.STRING, proto.STRING, number=4)
...
class UpdateWorkflowTemplateRequest(proto.Message):
    ...
    template = proto.Field(proto.MESSAGE, number=1,
        message='WorkflowTemplate',
    )
...
class ListWorkflowTemplatesResponse(proto.Message):
    ...
    Attributes:
        templates (Sequence[google.cloud.dataproc_v1beta2.types.WorkflowTemplate]):
    ...
    templates = proto.RepeatedField(proto.MESSAGE, number=1,
        message='WorkflowTemplate',
    )
