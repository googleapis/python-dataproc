...
class Cluster(proto.Message):
    ...
    Attributes:
        ...
        config (google.cloud.dataproc_v1beta2.types.ClusterConfig):
            Required. The cluster config. Note that
            Dataproc may set default values, and values may
            change when clusters are updated.
        labels (Sequence[google.cloud.dataproc_v1beta2.types.Cluster.LabelsEntry]):
        ...
        status (google.cloud.dataproc_v1beta2.types.ClusterStatus):
            Output only. Cluster status.
        status_history (Sequence[google.cloud.dataproc_v1beta2.types.ClusterStatus]):
            Output only. The previous cluster status.
        cluster_uuid (str):
            Output only. A cluster UUID (Unique Universal
            Identifier). Dataproc generates this value when
            it creates the cluster.
        metrics (google.cloud.dataproc_v1beta2.types.ClusterMetrics):
    ...
    status_history = proto.RepeatedField(proto.MESSAGE, number=7,
        message='ClusterStatus',
    )

    cluster_uuid = proto.Field(proto.STRING, number=6)

    metrics = proto.Field(proto.MESSAGE, number=9,
...
class ClusterConfig(proto.Message):
    ...
    Attributes:
        ...
        gce_cluster_config (google.cloud.dataproc_v1beta2.types.GceClusterConfig):
            Optional. The shared Compute Engine config
            settings for all instances in a cluster.
        master_config (google.cloud.dataproc_v1beta2.types.InstanceGroupConfig):
            Optional. The Compute Engine config settings
            for the master instance in a cluster.
        worker_config (google.cloud.dataproc_v1beta2.types.InstanceGroupConfig):
            Optional. The Compute Engine config settings
            for worker instances in a cluster.
        secondary_worker_config (google.cloud.dataproc_v1beta2.types.InstanceGroupConfig):
            Optional. The Compute Engine config settings
            for additional worker instances in a cluster.
        software_config (google.cloud.dataproc_v1beta2.types.SoftwareConfig):
            Optional. The config settings for software
            inside the cluster.
        lifecycle_config (google.cloud.dataproc_v1beta2.types.LifecycleConfig):
            Optional. The config setting for auto delete
            cluster schedule.
        initialization_actions (Sequence[google.cloud.dataproc_v1beta2.types.NodeInitializationAction]):
        ...
        encryption_config (google.cloud.dataproc_v1beta2.types.EncryptionConfig):
            Optional. Encryption settings for the
            cluster.
        autoscaling_config (google.cloud.dataproc_v1beta2.types.AutoscalingConfig):
            Optional. Autoscaling config for the policy
            associated with the cluster. Cluster does not
            autoscale if this field is unset.
        endpoint_config (google.cloud.dataproc_v1beta2.types.EndpointConfig):
            Optional. Port/endpoint configuration for
            this cluster
        security_config (google.cloud.dataproc_v1beta2.types.SecurityConfig):
            Optional. Security related configuration.
        gke_cluster_config (google.cloud.dataproc_v1beta2.types.GkeClusterConfig):
    ...
    gce_cluster_config = proto.Field(proto.MESSAGE, number=8,
        message='GceClusterConfig',
    )

    master_config = proto.Field(proto.MESSAGE, number=9,
        message='InstanceGroupConfig',
    )

    worker_config = proto.Field(proto.MESSAGE, number=10,
        message='InstanceGroupConfig',
    )

    secondary_worker_config = proto.Field(proto.MESSAGE, number=12,
        message='InstanceGroupConfig',
    )

    software_config = proto.Field(proto.MESSAGE, number=13,
        message='SoftwareConfig',
    )

    lifecycle_config = proto.Field(proto.MESSAGE, number=14,
        message='LifecycleConfig',
    )

    initialization_actions = proto.RepeatedField(proto.MESSAGE, number=11,
        message='NodeInitializationAction',
    )

    encryption_config = proto.Field(proto.MESSAGE, number=15,
        message='EncryptionConfig',
    )

    autoscaling_config = proto.Field(proto.MESSAGE, number=16,
        message='AutoscalingConfig',
    )

    endpoint_config = proto.Field(proto.MESSAGE, number=17,
        message='EndpointConfig',
    )

    security_config = proto.Field(proto.MESSAGE, number=18,
        message='SecurityConfig',
    )

    gke_cluster_config = proto.Field(proto.MESSAGE, number=19,
...
class GkeClusterConfig(proto.Message):
    ...
    Attributes:
        namespaced_gke_deployment_target (google.cloud.dataproc_v1beta2.types.GkeClusterConfig.NamespacedGkeDeploymentTarget):
    ...
    namespaced_gke_deployment_target = proto.Field(proto.MESSAGE, number=1,
...
class EndpointConfig(proto.Message):
    ...
    Attributes:
        http_ports (Sequence[google.cloud.dataproc_v1beta2.types.EndpointConfig.HttpPortsEntry]):
...
class GceClusterConfig(proto.Message):
    ...
    Attributes:
        ...
        metadata (Sequence[google.cloud.dataproc_v1beta2.types.GceClusterConfig.MetadataEntry]):
        ...
        reservation_affinity (google.cloud.dataproc_v1beta2.types.ReservationAffinity):
    ...
    reservation_affinity = proto.Field(proto.MESSAGE, number=11,
...
class InstanceGroupConfig(proto.Message):
    ...
    Attributes:
        ...
        disk_config (google.cloud.dataproc_v1beta2.types.DiskConfig):
            Optional. Disk option config settings.
        is_preemptible (bool):
            Output only. Specifies that this instance
            group contains preemptible instances.
        preemptibility (google.cloud.dataproc_v1beta2.types.InstanceGroupConfig.Preemptibility):
            ...
            ``PREEMPTIBLE``.
        managed_group_config (google.cloud.dataproc_v1beta2.types.ManagedGroupConfig):
            ...
            groups.
        accelerators (Sequence[google.cloud.dataproc_v1beta2.types.AcceleratorConfig]):
    ...
    disk_config = proto.Field(proto.MESSAGE, number=5,
        message='DiskConfig',
    )

    is_preemptible = proto.Field(proto.BOOL, number=6)

    preemptibility = proto.Field(proto.ENUM, number=10,
        enum=Preemptibility,
    )

    managed_group_config = proto.Field(proto.MESSAGE, number=7,
        message='ManagedGroupConfig',
    )

    accelerators = proto.RepeatedField(proto.MESSAGE, number=8,
...
class DiskConfig(proto.Message):
    ...
    Attributes:
        ...
        num_local_ssds (int):
            ...
            are not attached, the boot disk is used to store runtime
            logs and
...
class LifecycleConfig(proto.Message):
    ...
    idle_delete_ttl = proto.Field(proto.MESSAGE, number=1,
        message=duration.Duration,
    )

    auto_delete_time = proto.Field(proto.MESSAGE, number=2, oneof='ttl',
        message=timestamp.Timestamp,
    )

    auto_delete_ttl = proto.Field(proto.MESSAGE, number=3, oneof='ttl',
        message=duration.Duration,
    )

    idle_start_time = proto.Field(proto.MESSAGE, number=4,
        message=timestamp.Timestamp,
    )
...
class SecurityConfig(proto.Message):
    ...
    Attributes:
        kerberos_config (google.cloud.dataproc_v1beta2.types.KerberosConfig):
            Kerberos related configuration.
    """

    kerberos_config = proto.Field(proto.MESSAGE, number=1,
...
class KerberosConfig(proto.Message):
    ...
    Attributes:
        ...
        cross_realm_trust_realm (str):
            Optional. The remote realm the Dataproc on-
            luster KDC will trust, should the user enable
            cross realm trust.
...
class ClusterStatus(proto.Message):
    ...
    Attributes:
        state (google.cloud.dataproc_v1beta2.types.ClusterStatus.State):
            Output only. The cluster's state.
        detail (str):
            Output only. Optional details of cluster's
            state.
    ...
    state_start_time = proto.Field(proto.MESSAGE, number=3,
        message=timestamp.Timestamp,
    )

    substate = proto.Field(proto.ENUM, number=4,
        enum=Substate,
    )
...
class SoftwareConfig(proto.Message):
    ...
    Attributes:
        ...
        properties (Sequence[google.cloud.dataproc_v1beta2.types.SoftwareConfig.PropertiesEntry]):
        ...
        optional_components (Sequence[google.cloud.dataproc_v1beta2.types.Component]):
            The set of optional components to activate on
            the cluster.
    """
    ...
    optional_components = proto.RepeatedField(proto.ENUM, number=3,
...
class ClusterMetrics(proto.Message):
    ...
    **Beta Feature**: This report is available for testing purposes
    ...
    Attributes:
        hdfs_metrics (Sequence[google.cloud.dataproc_v1beta2.types.ClusterMetrics.HdfsMetricsEntry]):
            The HDFS metrics.
...
class UpdateClusterRequest(proto.Message):
    ...
    graceful_decommission_timeout = proto.Field(proto.MESSAGE, number=6,
        message=duration.Duration,
    )
...
class ListClustersResponse(proto.Message):
    ...
    Attributes:
        clusters (Sequence[google.cloud.dataproc_v1beta2.types.Cluster]):
...
class ReservationAffinity(proto.Message):
    ...
    Attributes:
        consume_reservation_type (google.cloud.dataproc_v1beta2.types.ReservationAffinity.Type):
