...
from google.cloud.dataproc_v1beta2.services.cluster_controller import ClusterControllerAsyncClient
from google.cloud.dataproc_v1beta2.services.cluster_controller import ClusterControllerClient
...
from google.cloud.dataproc_v1beta2.services.cluster_controller.transports.base import _API_CORE_VERSION
from google.cloud.dataproc_v1beta2.services.cluster_controller.transports.base import _GOOGLE_AUTH_VERSION
...
def test_cluster_controller_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_cluster_controller_client_client_options_from_dict():
    with mock.patch('google.cloud.dataproc_v1beta2.services.cluster_controller.transports.ClusterControllerGrpcTransport.__init__') as grpc_transport:
...
def test_create_cluster(transport: str = 'grpc', request_type=clusters.CreateClusterRequest):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_cluster(transport: str = 'grpc', request_type=clusters.UpdateClusterRequest):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_cluster(transport: str = 'grpc', request_type=clusters.DeleteClusterRequest):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_clusters(transport: str = 'grpc', request_type=clusters.ListClustersRequest):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_diagnose_cluster(transport: str = 'grpc', request_type=clusters.DiagnoseClusterRequest):
    client = ClusterControllerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cluster_controller_base_transport():
    ...
    with mock.patch('google.cloud.dataproc_v1beta2.services.cluster_controller.transports.ClusterControllerTransport.__init__') as Transport:
...
def test_cluster_controller_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dataproc_v1beta2.services.cluster_controller.transports.ClusterControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cluster_controller_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dataproc_v1beta2.services.cluster_controller.transports.ClusterControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ClusterControllerTransport()
        adc.assert_called_once()
...
def test_cluster_controller_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_cluster_controller_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
