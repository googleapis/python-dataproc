...
from .base import BatchControllerTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class BatchControllerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_batch(self, request: batches.CreateBatchRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[batches.CreateBatchRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_batch(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_batch(self, request: batches.DeleteBatchRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[batches.DeleteBatchRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_batch(self, request: batches.GetBatchRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[batches.GetBatchRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_batch(self, response: batches.Batch) -> batches.Batch:
        ...
        """
        return response
    def pre_list_batches(self, request: batches.ListBatchesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[batches.ListBatchesRequest, Sequence[Tuple[str, str]]]:
