...
class AutoscalingPolicyServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(AutoscalingPolicyServiceClient).get_transport_class, type(AutoscalingPolicyServiceClient))
    ...
    async def create_autoscaling_policy(self,
            request: Union[autoscaling_policies.CreateAutoscalingPolicyRequest, dict] = None,
            *,
            parent: str = None,
    ...
    async def update_autoscaling_policy(self,
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_autoscaling_policy(self,
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_autoscaling_policies(self,
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_autoscaling_policy(self,
