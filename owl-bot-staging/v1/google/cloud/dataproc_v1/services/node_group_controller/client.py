...
class NodeGroupControllerClient(metaclass=NodeGroupControllerClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, NodeGroupControllerTransport]] = None,
        ...
        if isinstance(transport, NodeGroupControllerTransport):
    ...
    def create_node_group(self,
        ...
        # in a node_groups.CreateNodeGroupRequest.
    ...
    def resize_node_group(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a node_groups.ResizeNodeGroupRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_node_group(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a node_groups.GetNodeGroupRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
