...
from google.cloud.dataproc_v1.services.batch_controller.transports.base import _GOOGLE_AUTH_VERSION
...
def test_batch_controller_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_get_batch(transport: str = 'grpc', request_type=batches.GetBatchRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = batches.Batch(
            ...
            pyspark_batch=batches.PySparkBatch(main_python_file_uri='main_python_file_uri_value'),
        )
