...
from google.cloud.dataproc_v1beta2.services.workflow_template_service import (
...
from google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.base import (
    _API_CORE_VERSION,
)
from google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.base import (
...
def test_workflow_template_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.WorkflowTemplateServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_workflow_template_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.WorkflowTemplateServiceTransport.__init__"
    ) as Transport:
...
def test_workflow_template_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.WorkflowTemplateServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_workflow_template_service_transport_create_channel_old_api_core(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@requires_api_core_lt_1_26_0
def test_workflow_template_service_transport_create_channel_user_scopes(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
