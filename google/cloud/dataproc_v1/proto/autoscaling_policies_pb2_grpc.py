...
from google.cloud.dataproc_v1.proto import autoscaling_policies_pb2 as google_dot_cloud_dot_dataproc__v1_dot_proto_dot_autoscaling__policies__pb2
...
class AutoscalingPolicyService(object):
    ...
    def CreateAutoscalingPolicy(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dataproc.v1.AutoscalingPolicyService/CreateAutoscalingPolicy',
    ...
    def UpdateAutoscalingPolicy(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dataproc.v1.AutoscalingPolicyService/UpdateAutoscalingPolicy',
    ...
    def GetAutoscalingPolicy(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dataproc.v1.AutoscalingPolicyService/GetAutoscalingPolicy',
    ...
    def ListAutoscalingPolicies(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dataproc.v1.AutoscalingPolicyService/ListAutoscalingPolicies',
    ...
    def DeleteAutoscalingPolicy(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dataproc.v1.AutoscalingPolicyService/DeleteAutoscalingPolicy',
