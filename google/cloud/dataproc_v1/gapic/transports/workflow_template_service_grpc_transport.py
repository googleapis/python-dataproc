...
class WorkflowTemplateServiceGrpcTransport(object):
    ...
    def __init__(self, channel=None, credentials=None,
        ...
        self._stubs = {
            'workflow_template_service_stub': workflow_templates_pb2_grpc.WorkflowTemplateServiceStub(channel),
        }
    ...
    def instantiate_inline_workflow_template(self):
        ...
        Returns:
            Callable: A callable which accepts the appropriate
                ...
                deserialized response object.
        """
        return self._stubs['workflow_template_service_stub'].InstantiateInlineWorkflowTemplate
