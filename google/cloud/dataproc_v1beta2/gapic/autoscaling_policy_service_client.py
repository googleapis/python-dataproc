...
from google.cloud.dataproc_v1beta2.gapic.transports import autoscaling_policy_service_grpc_transport
...
class AutoscalingPolicyServiceClient(object):
    ...
    def create_autoscaling_policy(
        ...
        if 'create_autoscaling_policy' not in self._inner_api_calls:
            self._inner_api_calls['create_autoscaling_policy'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['create_autoscaling_policy'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def update_autoscaling_policy(
        ...
        if 'update_autoscaling_policy' not in self._inner_api_calls:
            self._inner_api_calls['update_autoscaling_policy'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['update_autoscaling_policy'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def get_autoscaling_policy(
        ...
        if 'get_autoscaling_policy' not in self._inner_api_calls:
            self._inner_api_calls['get_autoscaling_policy'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        request = autoscaling_policies_pb2.GetAutoscalingPolicyRequest(
            name=name,
        )
        if metadata is None:
            metadata = []
        ...
        return self._inner_api_calls['get_autoscaling_policy'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def list_autoscaling_policies(
        ...
        if 'list_autoscaling_policies' not in self._inner_api_calls:
            self._inner_api_calls['list_autoscaling_policies'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_autoscaling_policies'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
    ...
    def delete_autoscaling_policy(
        ...
        if 'delete_autoscaling_policy' not in self._inner_api_calls:
            self._inner_api_calls['delete_autoscaling_policy'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        request = autoscaling_policies_pb2.DeleteAutoscalingPolicyRequest(
            name=name,
        )
        if metadata is None:
            metadata = []
        ...
        self._inner_api_calls['delete_autoscaling_policy'](request, retry=retry, timeout=timeout, metadata=metadata)
