...
ClusterConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      config_bucket:
          ...
          bucket <https://cloud.google.com/dataproc/docs/concepts
          /configuring-clusters/staging-bucket>`__).
      gce_cluster_config:
      ...
      initialization_actions:
          ...
          http://metadata/computeMetadata/v1beta2/instance/attributes
          /dataproc-role)    if [[ "${ROLE}" == 'Master' ]]; then
    ...
    (_message.Message,),
    {
        "NamespacedGkeDeploymentTarget": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                "__module__": "google.cloud.dataproc_v1beta2.proto.clusters_pb2",
                "__doc__": """A full, namespace-isolated deployment target for an
...
GceClusterConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      service_account:
          ...
          service account <https://cloud.google.com/compute/docs/access
          /service-accounts#default_service_account>`__ is used.
...
AcceleratorConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      accelerator_type_uri:
          ...
          ``projects/[project_id]/zones/us-east1-a/acceleratorTypes
          /nvidia-tesla-k80`` \* ``nvidia-tesla-k80``  **Auto Zone
          Exception**: If you are using the Dataproc `Auto Zone
          Placement <https://cloud.google.com/dataproc/docs/concepts
          /configuring-clusters/auto-zone#using_auto_zone_placement>`__
...
ClusterStatus = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      state_start_time:
          ...
          representation of `Timestamp <https://developers.google.com
          /protocol-buffers/docs/proto3#json>`__).
      substate:
...
SoftwareConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      image_version:
          ...
          /dataproc-versions#supported_cloud_dataproc_versions>`__, such
          as “1.2” (including a subminor version, such as “1.2.29”), or
          the `“preview” version
          <https://cloud.google.com/dataproc/docs/concepts/versioning
          /dataproc-versions#other_versions>`__. If unspecified, it
      ...
      properties:
          ...
          properties <https://cloud.google.com/dataproc/docs/concepts
          /cluster-properties>`__.
      optional_components:
